...
public class NativeIO {
  public static class POSIX {
      ...
      if (!Shell.WINDOWS) {
        ...
        try {
          ...
          if (nioe.getErrorCode() == 3) {
            ...
            throw new org.apache.hadoop.io.nativeio.NativeIOException("Unknown error", org.apache.hadoop.io.nativeio.Errno.UNKNOWN);
          }
        }
      }
    }
    ...
    static native void posix_fadvise(
            FileDescriptor fd, long offset, long len, int flags) throws org.apache.hadoop.io.nativeio.NativeIOException;

    /** Wrapper around sync_file_range(2) */
    static native void sync_file_range(
            FileDescriptor fd, long offset, long nbytes, int flags) throws org.apache.hadoop.io.nativeio.NativeIOException;
     ...
     *
     * @throws org.apache.hadoop.io.nativeio.NativeIOException if there is an error with the syscall
     */
    ...
    static native void mlock_native(
            ByteBuffer buffer, long len) throws org.apache.hadoop.io.nativeio.NativeIOException;
   ...
   *
   * @throws org.apache.hadoop.io.nativeio.NativeIOException   On failure.
   */
